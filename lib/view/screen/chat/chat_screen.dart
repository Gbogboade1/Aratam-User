...
import 'package:flutter_sixvalley_ecommerce/view/screen/chat/videochat_screen.dart';
import 'package:flutter_sixvalley_ecommerce/view/screen/chat/audiochat_screen.dart';
...
class ChatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(seller.fName + ' ' + seller.lName), actions: [
        IconButton(
          onPressed: () {
            Navigator.push(
        ...
        IconButton(
          onPressed: () {
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (_) => VideoChatScreen(
                          seller: seller,
                        )));
          },
          icon: Image.asset('assets/images/video-call.png'),
        )
      ]),
      ...
      body: Column(
        ...
        // Bottom TextField
        ChatTextField(controller: _controller, seller: seller),
      ]),
    );
  }
}
